...
We are selecting this model as our best performance model, as it incroporates the best methods/processes that we tried in order for the architecure to learn semantic segmenation. We can also select it by its performance on the mean IoU across majority and minority labels, as we rate performance on minority classes as long as majority classes don't lose coherence. 
